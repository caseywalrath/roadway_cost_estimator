...
The current data package includes synthetic demo records and public CDOT 2025 Q4 and 2026 Q1 Cost Data Book records. It is prototype evidence, not estimating guidance.
...
- Public CDOT Cost Data Book imports use one source row per period, with stable period-specific IDs such as `cdot_cost_data_book_2025_q4` and `cdot_cost_data_book_2026_q1`.
