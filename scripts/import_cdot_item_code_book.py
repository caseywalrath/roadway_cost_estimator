...
KNOWN_SECTIONS = {
    "000": ("000", "Administrative Items", "Project Development and Construction Engineering"),
    ...
    "211": ("200", "Earthwork", "Tunnel Excavation and Rock Reinforcement"),
    ...
    "218": ("200", "Earthwork", "Noxious Weed Management"),
    "240": ("200", "Earthwork", "Wildlife Protection"),
    "250": ("200", "Earthwork", "Environmental, Health and Safety Management"),
    "251": ("200", "Earthwork", "Paint Testing and Analysis Management"),
    "301": ("300", "Bases", "Plant Mix Bituminous Base"),
    "304": ("300", "Bases", "Aggregate Base Course"),
    "306": ("300", "Bases", "Reconditioning"),
    "307": ("300", "Bases", "Lime Treated Subgrade"),
    "308": ("300", "Bases", "Stabilized Bases"),
    "310": ("300", "Bases", "Full Depth Reclamation"),
    ...
    "410": ("400", "Pavements", "Slurry Seal Coat"),
    ...
    "511": ("500", "Structures", "Structural Precast Concrete Arch Units"),
    "512": ("500", "Structures", "Bearing Device"),
    "513": ("500", "Structures", "Bridge Drains"),
    ...
    "519": ("500", "Structures", "Concrete Structure Repair"),
    "520": ("500", "Structures", "Bridge Hanger Cable Assembly"),
    "521": ("500", "Structures", "Slurry Walls"),
    "522": ("500", "Structures", "Galvanized Surface Treatment"),
    ...
    "621": ("600", "Miscellaneous Construction", "Detours and Temporary Structures"),
    ...
    "628": ("600", "Miscellaneous Construction", "Bridge Girder and Deck Units"),
    ...
    "631": ("600", "Miscellaneous Construction", "Design and Construction Allowances"),
    "632": ("600", "Miscellaneous Construction", "Night Work Lighting"),
    "637": ("600", "Miscellaneous Construction", "Roadway Sweeping"),
    "641": ("600", "Miscellaneous Construction", "Shotcrete"),
    "642": ("600", "Miscellaneous Construction", "Avalanche Control Equipment"),
    "660": ("600", "Miscellaneous Construction", "Special Systems"),
    "670": ("600", "Miscellaneous Construction", "Electrical Systems"),
    "680": ("600", "Miscellaneous Construction", "Lighting Systems"),
    "699": ("600", "Miscellaneous Construction", "Fixed Fee"),
    "700": ("700", "Materials", "Force Account"),
    ...
    "800": ("800", "Owner-Furnished and Right-of-Way Items", "Owner-Furnished Materials and Right-of-Way"),
    "900": ("900", "Added Items and Project Controls", "Added Items"),
    "950": ("900", "Added Items and Project Controls", "Project Control Accounts"),
}
